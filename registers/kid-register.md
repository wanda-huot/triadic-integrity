...
```text
My cup has enough room for the next step.
```

This does not mean the child is perfectly calm.

It means the child is ready enough to try.
...
- name the pattern, not the child as bad
- avoid shame
- use concrete body and action language
- offer one small next move
- do not over-explain during a meltdown
- repair later when the child has more room
...
It should not be used to diagnose children.

It should not replace professional support when a child or family needs it.

Use it as a simple shared language for noticing, regulating, repairing, and choosing safer next moves.
